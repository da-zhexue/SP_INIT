...
void HAL_ADC_MspInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PA2     ------> ADC1_IN3
    */
    GPIO_InitStruct.Pin = V_CHASSIS_Pin|I_REFEREE_Pin|I_A_Pin;
  ...
  /* USER CODE END ADC2_MspInit 0 */
    ...
    PC3     ------> ADC2_IN9
    */
    GPIO_InitStruct.Pin = CAP_I_Pin|TEMP_Pin|V_CAP_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* adcHandle)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA2     ------> ADC1_IN3
    */
    HAL_GPIO_DeInit(GPIOA, V_CHASSIS_Pin|I_REFEREE_Pin|I_A_Pin);
  ...
  /* USER CODE END ADC2_MspDeInit 0 */
    ...
    PC3     ------> ADC2_IN9
    */
    HAL_GPIO_DeInit(GPIOC, CAP_I_Pin|TEMP_Pin|V_CAP_Pin);
